...
describe('MatrixCacheService', () => {
  ...
  describe('Basic Cache Operations', () => {
    ...
    it('should clear all entries correctly', () => {
      ...
      const matrix1 = matrixFactory.fromArray([[1, 2], [3, 4]]);
      const matrix2 = matrixFactory.fromArray([[5, 6], [7, 8]]);
  ...
  describe('LRU Eviction', () => {
    it('should evict least recently used entries when cache is full', () => {
      ...
      // Add a small matrix
      const smallMatrix = matrixFactory.fromArray([[1, 2], [3, 4]]);
    ...
    it('should move accessed entries to head of LRU list', () => {
      ...
      const matrix1 = matrixFactory.fromArray([[1, 2], [3, 4]]);
      const matrix2 = matrixFactory.fromArray([[5, 6], [7, 8]]);
      const matrix3 = matrixFactory.fromArray([[9, 10], [11, 12]]);
  ...
  describe('Performance Metrics', () => {
    ...
    it('should update performance metrics correctly', () => {
      ...
      const mockOperationResult = {
        result: matrixFactory.fromArray([[1, 2], [3, 4]]),
        performance: {
          executionTime: 10,
          memoryUsed: 1024,
          operationType: 'add',
