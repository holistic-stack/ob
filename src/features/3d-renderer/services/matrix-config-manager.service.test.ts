...
describe('MatrixConfigManagerService', () => {
  ...
  describe('Initialization', () => {
    it('should initialize with default configuration', () => {
      ...
      expect(config.performance.maxDirectOperationSize).toBe(
        MATRIX_CONFIG.performance.maxDirectOperationSize
      );
  ...
  describe('Configuration Overrides', () => {
    ...
    it('should maintain change history', () => {
      ...
      const performanceChange = history.find(
        (h) => h.property === 'performance.performanceThreshold'
      );
  ...
  describe('Performance Threshold Management', () => {
    it('should suggest threshold adjustments based on metrics', () => {
      ...
      if (multiplyAdjustment) {
        expect(multiplyAdjustment.suggestedThreshold).toBeLessThan(
          multiplyAdjustment.currentThreshold
        );
      }
  ...
  describe('Error Handling', () => {
    ...
    it('should maintain configuration integrity on failed overrides', () => {
      ...
      expect(currentConfig.performance.maxDirectOperationSize).toBe(
        originalConfig.performance.maxDirectOperationSize
      );
    });
  });
});
