 ...
 */
const generateRegressionReport = (measurements: PerformanceMeasurement[]): PerformanceRegressionReport => {
  ...
  const averageRegression = regressions.length > 0 ? regressions.reduce((a, b) => a + b, 0) / regressions.length : 0;
...
describe('Matrix Performance Regression Testing Framework', () => {
  ...
  describe('Matrix Conversion Performance', () => {
    it('should maintain Matrix4 to ml-matrix conversion performance', async () => {
      console.log('[DEBUG][PerformanceRegressionTest] Testing Matrix4 to ml-matrix conversion performance');
      ...
      if (measurement.isSignificant) {
        expect(measurement.averageTime).toBeLessThan(measurement.baseline + measurement.tolerance);
      }
    }, PERFORMANCE_TEST_CONFIG.timeoutMs);

    it('should maintain normal matrix computation performance', async () => {
      console.log('[DEBUG][PerformanceRegressionTest] Testing normal matrix computation performance');
  ...
  describe('Matrix Validation Performance', () => {
    it('should maintain basic validation performance', async () => {
    ...
    it('should maintain numerical stability analysis performance', async () => {
  ...
  describe('Cache Operations Performance', () => {
    it('should maintain cache get operation performance', async () => {
    ...
    it('should maintain cache set operation performance', async () => {
  ...
  describe('Service Container Performance', () => {
    it('should maintain health check performance', async () => {
  ...
  describe('End-to-End Performance', () => {
    it('should maintain overall workflow performance', async () => {
      ...
      const averageWorkflowTime = workflowMeasurements.reduce((a, b) => a + b, 0) / workflowMeasurements.length;
