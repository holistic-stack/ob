...
const CAMERA_VIEWS: Record<string, R3FCameraView> = {
  front: {
    ...
    target: [0, 0, 0],
    label: 'Front',
    color: DEFAULT_CONFIG.faceColors.front
  },
  back: {
    position: [0, 0, -15],
    target: [0, 0, 0],
    label: 'Back',
    color: DEFAULT_CONFIG.faceColors.back
  },
  left: {
    position: [-15, 0, 0],
    target: [0, 0, 0],
    label: 'Left',
    color: DEFAULT_CONFIG.faceColors.left
  },
  right: {
    position: [15, 0, 0],
    target: [0, 0, 0],
    label: 'Right',
    color: DEFAULT_CONFIG.faceColors.right
  },
  top: {
    position: [0, 15, 0],
    target: [0, 0, 0],
    label: 'Top',
    color: DEFAULT_CONFIG.faceColors.top
  },
  bottom: {
    position: [0, -15, 0],
    target: [0, 0, 0],
    label: 'Bottom',
    color: DEFAULT_CONFIG.faceColors.bottom
  }
};
