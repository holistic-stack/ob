 ...
 */
export function calculateAxisEndpoints(config: AxisEndpointsConfig): AxisEndpoints {
 ...
 */
export function calculateFullAxisEndpoints(config: AxisEndpointsConfig): AxisEndpoints {
 ...
 */
export function getAxisRotation(axisName: 'X' | 'Y' | 'Z'): Vector3 {
 ...
 */
export function getAxisDirection(axisName: 'X' | 'Y' | 'Z'): Vector3 {
 ...
 */
export function normalizeDirection(direction: Vector3): Vector3 {
 ...
 */
export function createLinePoints(origin: Vector3, endpoint: Vector3): Vector3[] {
 ...
 */
export function createAxisLinePoints(config: AxisEndpointsConfig): {
  positive: Vector3[];
  negative: Vector3[];
} {
  const endpoints = calculateAxisEndpoints(config);

  return {
    positive: createLinePoints(config.origin, endpoints.positiveEnd),
    negative: createLinePoints(endpoints.negativeEnd, config.origin),
  };
}
 ...
 */
export function isValidDirection(direction: Vector3): boolean {
