...
vi.mock('./monaco-editor', () => ({
  MonacoEditorComponent: ({ value, onChange, onCursorPositionChange, onSelectionChange, ...props }: any) => {
    return (
...
vi.mock('../../store/app-store', () => ({
  useAppStore: vi.fn((selector) => {
    if (typeof selector === 'function') {
      ...
      if (selectorName === 'selectConfigEnableRealTimeParsing') return mockStoreState.config.enableRealTimeParsing;
...
describe('StoreConnectedEditor', () => {
  ...
  describe('Store Integration', () => {
    ...
    it('should display parsing warnings from store', () => {
      mockStoreState.parsing.warnings = ['Deprecated function used'];
