...
│   ├── node-factory.ts                  # BabylonJS node creation
│   ├── parameter-mapper.ts              # Parameter conversion utilities
│   ├── type-guards.ts                   # Type checking utilities
│   └── index.ts                         # Bridge exports
├── types/
│   ├── babylonjs-node.types.ts          # BabylonJS-extended AST types
│   ├── conversion-result.types.ts       # Bridge conversion result types
│   └── index.ts                         # Type exports
├── core/
│   ├── openscad-babylon-node.ts         # Base class extending BABYLON.AbstractMesh
│   ├── primitive-babylon-node.ts        # BabylonJS primitive implementations
│   ├── transform-babylon-node.ts        # BabylonJS transform implementations
│   ├── csg-babylon-node.ts              # BabylonJS CSG implementations
│   └── index.ts                         # Core exports
├── services/
│   ├── mesh-generation.service.ts       # Scene & mesh generation
│   ├── babylon-integration.service.ts   # BabylonJS scene integration
