...
function fixPositionInterfaces(filePath) {
  ...
  content = content.replace(pattern1, (_match, line, column) => {
    fixCount++;
  ...
  content = content.replace(pattern2, (_match, line, column) => {
    fixCount++;
  ...
  content = content.replace(pattern3, (_match, prop, line, column) => {
    fixCount++;
